 ...
 * The Or class, extends the BinaryExpression class.
...
public class Or extends BinaryExpression {
    ...
    public Expression assign(String var, Expression expression) {
        return new Or(this.getExpressions()[0].assign(var, expression),
    ...
    public Expression nandify() {
        return new Nand(new Nand(this.getExpressions()[0].nandify(), this.getExpressions()[0].nandify()),
                new Nand(this.getExpressions()[1].nandify(), this.getExpressions()[1].nandify()));
    }
    ...
    public Expression norify() {
        return new Nor(new Nor(this.getExpressions()[0].norify(), this.getExpressions()[1].norify()),
