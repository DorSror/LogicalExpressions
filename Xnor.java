 ...
 * The Xnor class, extends the BinaryExpression class.
 * Represents a logical Xnor operation.
 */
public class Xnor extends BinaryExpression {
    ...
    public Expression assign(String var, Expression expression) {
        return new Xnor(this.getExpressions()[0].assign(var, expression),
    ...
    public Expression nandify() {
        ...
        return new Nand(temporary.nandify(), new Nand(this.getExpressions()[0].nandify(),
                this.getExpressions()[1].nandify()));
    }
    ...
    public Expression norify() {
        Nor inner = new Nor(this.getExpressions()[0].norify(), this.getExpressions()[1].norify());
        return new Nor(new Nor(this.getExpressions()[0].norify(), inner),
                new Nor(this.getExpressions()[1].norify(), inner));
    }
    ...
    public Expression simplify() {
        ...
        if ((simplified1.toString().equals("F") && simplified2.toString().equals("T"))
                || (simplified1.toString().equals("T") && simplified2.toString().equals("F"))) {
