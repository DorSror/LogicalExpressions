 ...
 * The Nand class, extends the BinaryExpression class.
...
public class Nand extends BinaryExpression {
    ...
    public Boolean evaluate(Map<String, Boolean> assignment) throws Exception {
        return !(new And(this.getExpressions()[0], this.getExpressions()[1]).evaluate(assignment));
    }
    ...
    public Boolean evaluate() throws Exception {
        return !(new And(this.getExpressions()[0], this.getExpressions()[1]).evaluate());
    }
    ...
    public String toString() {
        return "(" + this.getExpressions()[0].toString() + " A " + this.getExpressions()[1].toString() + ")";
    }
    ...
    public Expression assign(String var, Expression expression) {
        return new Nand(this.getExpressions()[0].assign(var, expression),
    ...
    public Expression nandify() {
        return new Nand(this.getExpressions()[0].nandify(), this.getExpressions()[1].nandify());
    }
    ...
    public Expression norify() {
        ...
        return new Nor(temporary.norify(), temporary.norify());
    }
    ...
    public Expression simplify() {
        ...
        if (simplified1.toString().equals("T") || simplified1.toString().equals(simplified2.toString())) {
