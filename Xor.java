 ...
 * The Xor class, extends the BinaryExpression class.
...
public class Xor extends BinaryExpression {
    ...
    public Boolean evaluate(Map<String, Boolean> assignment) throws Exception {
        return (this.getExpressions()[0].evaluate(assignment) || this.getExpressions()[1].evaluate(assignment))
                && !(this.getExpressions()[0].evaluate(assignment) && this.getExpressions()[1].evaluate(assignment));
    }
    ...
    public Boolean evaluate() throws Exception {
        return (super.getExpressions()[0].evaluate() || this.getExpressions()[1].evaluate())
                && !(this.getExpressions()[0].evaluate() && this.getExpressions()[1].evaluate());
    }
    ...
    public Expression assign(String var, Expression expression) {
        return new Xor(this.getExpressions()[0].assign(var, expression),
    ...
    public Expression nandify() {
        Nand inner = new Nand(this.getExpressions()[0].nandify(), this.getExpressions()[1].nandify());
        return new Nand(new Nand(this.getExpressions()[0].nandify(), inner),
                new Nand(this.getExpressions()[1].nandify(), inner));
    }
    ...
    public Expression norify() {
        And temporary = new And(this.getExpressions()[0].norify(), this.getExpressions()[1].norify());
        return new Nor(temporary.norify(),
                new Nor(this.getExpressions()[0].norify(), this.getExpressions()[1].norify()));
    }
    ...
    public Expression simplify() {
        ...
        if (simplified2.toString().equals("T")) {
            if (simplified1.toString().equals("F")) {
                return new Val(true);
            }
